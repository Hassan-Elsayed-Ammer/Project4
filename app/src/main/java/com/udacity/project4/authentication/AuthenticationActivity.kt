...
class AuthenticationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.loginButton.setOnClickListener { signInWithAuthUI() }

        launcher =
            registerForActivityResult(ActivityResultContracts.StartActivityForResult()) { check ->
        ...
        viewModel.state.observe(this) { authentication ->
            when (authentication) {
                ...
                else -> Log.d("Login", "Failed to login")
            }
        }
    ...
    private fun signInWithAuthUI() {
        ...
        launcher.launch(
            AuthUI.getInstance().createSignInIntentBuilder().setAuthMethodPickerLayout(layout)
